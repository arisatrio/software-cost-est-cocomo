            ...
            <div class="mb-4">
                <div class="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="h-8 w-8 {{ $avgEffortAccuracy <= 0.25 ? 'text-green-500' : ($avgEffortAccuracy <= 0.50 ? 'text-blue-500' : ($avgEffortAccuracy <= 0.75 ? 'text-yellow-500' : 'text-red-500')) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
                            </div>
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900">MMRE Effort</h3>
                                <p class="text-3xl font-bold {{ $avgEffortAccuracy <= 0.25 ? 'text-green-600' : ($avgEffortAccuracy <= 0.50 ? 'text-blue-600' : ($avgEffortAccuracy <= 0.75 ? 'text-yellow-600' : 'text-red-600')) }}">{{ number_format($avgEffortAccuracy, 3) }}</p>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="h-8 w-8 {{ $avgScheduleAccuracy <= 0.25 ? 'text-green-500' : ($avgScheduleAccuracy <= 0.50 ? 'text-blue-500' : ($avgScheduleAccuracy <= 0.75 ? 'text-yellow-500' : 'text-red-500')) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900">MMRE Schedule</h3>
                                <p class="text-3xl font-bold {{ $avgScheduleAccuracy <= 0.25 ? 'text-green-600' : ($avgScheduleAccuracy <= 0.50 ? 'text-blue-600' : ($avgScheduleAccuracy <= 0.75 ? 'text-yellow-600' : 'text-red-600')) }}">{{ number_format($avgScheduleAccuracy, 3) }}</p>
                                <p class="text-sm text-gray-500">Average Schedule</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="h-8 w-8 {{ $avgPersonnelAccuracy <= 0.25 ? 'text-green-500' : ($avgPersonnelAccuracy <= 0.50 ? 'text-blue-500' : ($avgPersonnelAccuracy <= 0.75 ? 'text-yellow-500' : 'text-red-500')) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold {{ $avgPersonnelAccuracy <= 0.25 ? 'text-green-600' : ($avgPersonnelAccuracy <= 0.50 ? 'text-blue-600' : ($avgPersonnelAccuracy <= 0.75 ? 'text-yellow-600' : 'text-red-600')) }}">{{ number_format($avgPersonnelAccuracy, 3) }}</p>
                                <p class="text-sm text-gray-500">Average Personnel</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="h-8 w-8 {{ $avgOverallAccuracy <= 0.25 ? 'text-green-500' : ($avgOverallAccuracy <= 0.50 ? 'text-blue-500' : ($avgOverallAccuracy <= 0.75 ? 'text-yellow-500' : 'text-red-500')) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900">MMRE Keseluruhan</h3>
                                <p class="text-3xl font-bold {{ $avgOverallAccuracy <= 0.25 ? 'text-green-600' : ($avgOverallAccuracy <= 0.50 ? 'text-blue-600' : ($avgOverallAccuracy <= 0.75 ? 'text-yellow-600' : 'text-red-600')) }}">{{ number_format($avgOverallAccuracy, 3) }}</p>
